            ...
            {authProfileToggle && (
                ...
                shadow-md rounded-md text-center z-40`}>
                    <div className='flex p-5  border-b border-gray-500 items-center justify-center flex-col'>
                        ...
                        <div
                            className='w-16 h-16 rounded-full bg-secondary overflow-hidden flex justify-center items-center mr-3'>
                    ...
                    <div className='flex  flex-col items-start p-5 border-b border-gray-500'>
                        <span
                            className="cursor-pointer inline-flex items-start justify-start dark:text-gray hover:text-secondary transition duration-3000"
                            onClick={profileOverlayHandler}>Profile</span>
                    </div>
                    <div className='p-5 flex items-start'>
                        <span
                            className="cursor-pointer inline-flex items-start justify-start dark:text-gray hover:text-secondary transition duration-3000"
                            onClick={logoutHandler}>Logout</span>
                    </div>
                </div>
            )}
            <Sidebar/>
